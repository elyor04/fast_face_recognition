...
from cv2 import (
    VideoCapture, resize, INTER_AREA, rectangle, getTextSize, putText,
    FONT_HERSHEY_COMPLEX_SMALL, imshow, waitKey, destroyAllWindows)
...
while True:
    ...
    rgb_img = resize(bgr_img, (0,0), fx=0.4, fy=0.4, interpolation=INTER_AREA)[:, :, ::-1]
    ...
    for (y, x2, y2, x), name in zip(getFixed(locs, 2.5), names):
        ...
        putText(bgr_img, name, (x,y2+18), FONT_HERSHEY_COMPLEX_SMALL, 1.0, (0,250,0), 1)
